  ...
  return (
    ...
    <div className="about-game-main gGTSDy">
      <div className="hzeyLF">
        ...
        <p className='f-size'>
          ...
          market was introduced back in 70’s by Star143.
        </p>
    ...
    <div className="about-game-main dFgvOd">
      <div className="jcyUcB">
        <h1 className="h1-fw-600 mt-30px">This is how you play matka on Star143:</h1>
        <ul className="iKDfcs">
      ...
      <div className="jcyUcB">
        <h1 className="h1-fw-600">How to add money in Star143?</h1>
        <ul className="iKDfcs">
          <li className="hTaGYD f-size">
      ...
      <ul className="cKTdPD">
        ...
        >
          ...
          for withdrawal request on our Star143 Mobile App.
        </li>
        <li className='f-size'
        >
      ...
      <div className="jcyUcB">
        ...
        >
          ...
          the numbers game at Star143.com
        </p>
      </div>
      <div className="jcyUcB">
      ...
      <div className="jcyUcB">
        ...
        >
          ...
          earn the bulk of the prize pool. The legendary Star143 is popularly
      ...
      <div className="jcyUcB">
        ...
        >
          ...
          Star143 having celebrities pull draws for him. The game has since lost
